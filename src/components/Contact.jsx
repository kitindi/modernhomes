          ...
          <div className="w-full  rounded bg-[#f2f8ff]  p-5 md:p-8">
            ...
            <form action="">
              ...
              <div className="mb-3">
                ...
                <input type="email" id="email" name="email" className="w-full p-2 border border-[#0f4189] rounded-md focus:outline-none" />
              </div>
              ...
              <div className="mb-2">
                ...
                <textarea name="message" id="" className="w-full p-2 border border-[#0f4189] rounded-md  focus:outline-none" rows={3}></textarea>
              </div>
              <div className="mb-2">
                <button className="bg-[#ff793f] text-[#ffffff] text-md font-medium rounded-full w-full px-8 py-2"> Submit</button>
              </div>
            </form>
          </div>
        </div>
